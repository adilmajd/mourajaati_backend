...
from data.user import get_user_details, login_user, require_permission,require_role, update_password,users_search,get_roles_permissions,update_user_roles,get_user_etat,update_user_etat,delete_role,delete_permission,get_role_permissions,add_permission_to_role,remove_permission_from_role,upload_avatar,get_avatar
from database.base import get_session
from sqlmodel import Session, select
from typing import List, Optional
from model.Autre import LoginRequest, PasswordUpdate, RoleCreate, UpdateUserRoles,PermissionCreate, UserDetailResponse
...
@router.get("/user/{user_public_id}/details")
def get_user_details_r(user_public_id: str, session: Session = Depends(get_session)):
    return get_user_details(user_public_id,session)
